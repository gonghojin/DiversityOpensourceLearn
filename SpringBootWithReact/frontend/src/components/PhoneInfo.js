...
class PhoneInfo extends Component {
    ...
    state = {
        // 수정 버튼을 눌렀을 때 editing 값을 true로 설정해줄 것이다.
        // 이 값이 true일 떄는, 기존에 텍스트 형태로 보여주던 값들을
        // input 형태로 보여주게 된다.
        editing: false,
        // input의 값은 유동적이다.
        // 따라서 input 값을 담기 위해서 각 필드를 위한 값도 설정해야 한다.
        name: '',
        phone: ''
    }
    ...
    handleChange = (e) => {
        ...
        this.setState({
            // 왜 name을 배열로 감쌀까? https://medium.com/@bretdoucette/understanding-this-setstate-name-value-a5ef7b4ea2b4
            [name]: value
        });
    }
